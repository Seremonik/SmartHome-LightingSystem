...
Switch *LightSwitches[] =
{
        ...
        new LightSwitch((int[]){2,3}, 2, (int[]){38}, 1, systemTopic + "Wiatrolap_Ambient"),
        new LightSwitch((int[]){A3, A2}, 2, (int[]){37}, 1, systemTopic + "Maszynownia"),
        ...
        new LightSwitch((int[]){A7, A9}, 2, (int[]){28}, 1, systemTopic + "Kuchnia_Blaty"),
        new LightSwitch((int[]){A8}, 1, (int[]){32}, 1, systemTopic + "Kuchnia_Barek"),
        new LightSwitch((int[]){}, 0, (int[]){31}, 1, systemTopic + "Kuchnia_Ambient"),
    ...
    #endif
    #ifdef Shutters
        new ShutterSwitch((int[]){A0, A3}, (int[]){46, 47}, 87000000, systemTopic + "Salon_Zaluzja"),
        new ShutterSwitch((int[]){A4, A5}, (int[]){45, 44}, 87000000, systemTopic + "Jadalnia_Zaluzja"),
        new ShutterSwitch((int[]){A6, A7}, (int[]){42, 40}, 90000000, systemTopic + "Jadalnia_Roleta"),
